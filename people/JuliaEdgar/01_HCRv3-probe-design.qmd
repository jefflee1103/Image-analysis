...
fasta_file <- "./probe_design/input/Mobp-cDNA.fa" 
target_name <- "mMobp"
...
```{r}
## ---- Set params
blast_file <- "~/Documents/Data/BLAST/Mmus/Mmus_ens99_from-MK.fa"
tx2gene_csv <- "~/Documents/Github/HCRv3_probe_design_personal/data/Mmus_tx2gene_ENSEMBL_v99.csv" # To convert tx_id to gene_id
